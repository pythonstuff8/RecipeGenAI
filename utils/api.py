...
def gen_recipe(prompt, api_key):
    OPENAI_API_KEY = (
        "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"
    )
    ...
    if response.status_code == 200:
        ...
        if image_response.status_code == 200:
            ...
            try:
                base64_data = image_data["candidates"][0]["content"]["parts"][1][
                    "inlineData"
                ]["data"]
            except Exception:
                image_response = requests.post(url, headers=headers, json=payload)
